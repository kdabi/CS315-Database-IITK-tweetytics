...
class User(models.Model):
    ...
    profile_background_image_url = models.URLField(default='None',null=True)
    profile_background_color = models.CharField(max_length=6,null=True)
    profile_banner_url = models.URLField(default='None',null=True)
    friends_count = models.BigIntegerField(null=True)
    profile_image_url = models.URLField(default='None',null=True)
